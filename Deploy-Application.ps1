...
Try {
	...
	[string]$appScriptDate = '07/08/2019'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		# Uninstall 2017
		If (Test-Path -Path "${envProgramFilesX86}\Microsoft Visual Studio\2017\Professional\Common7\IDE\devenv.exe" -PathType 'Leaf') {
			Write-Log -Message "Removing Visual Studio 2017..." -Severity 2 -Source $deployAppScriptFriendlyName
		...
		Copy-File -Path "$dirFiles\VS2019.vsconfig" -Destination "C:\Temp\MSUDenver"
		$exitCode = Execute-Process -Path "vs_community.exe" -Parameters "--quiet --wait --norestart --Config `"C:\Temp\MSUDenver\VS2019.vsconfig`"" -WindowStyle "Hidden" -WaitForMsiExec -PassThru
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB58uVTcEtTx0Mr
# hf9q2CXhQ4eJD5/zNxkvBisZzaVeSqCCFFwwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg0ZDZgM0j
# oqJsqsXxtZq5unrscbCt0QMA9Pn5paBEE44wDQYJKoZIhvcNAQEBBQAEggEAwNXa
# FxPR0hbxCxQwgJtTYWHmryA0aK7Mx11c4amoYC68IJYIrVwrVwZlbiYtfGXZpEmY
# RxRmlFFqFLR2nNv2cg7rIYylsHgogcs2d7Uh98xZ0EUMRwBKkB7EFRqnQD40xhhS
# OzmztSjkh3eW2oWsyNAIsVdJHBLBkZ9O7i/92Ks4/KbJR3QNPCjf1+JObdCp/j/c
# 556M0D+PUeZf5xmTzHCyRQJl91hNPNuD9giSiYvf8k3PBxmtuDT1MMbkpHDHXtfi
# BnjikH9PXh6W8SfqqfRrhz577fbsw6LmoTCaqW13hFj975WLVn/Vu9DbojPS2/8z
# E2bX6aGvzeZJ+khNgKGCAqIwggKeBgkqhkiG9w0BCQYxggKPMIICiwIBATBoMFIx
...
# CSqGSIb3DQEJBTEPFw0xOTA3MDkxNzAxMjVaMCMGCSqGSIb3DQEJBDEWBBTGf17S
# hdwqxxgXSGVsPr1i3DRuNTCBnQYLKoZIhvcNAQkQAgwxgY0wgYowgYcwgYQEFGO4
...
# ggEAe1xpA2xg4OO6zNarCA5xlSUWlaBl01/S4HuSBJYOdwUUjRSM5HUc94O4ZEzb
# WDcixNArYp1pG62mbnbZY+gPdaCXl8PKzyM+K6Od1EuSwKEd+f538lJ5b2esgzmy
# cA/u+2XEWyPME7klfStrcQpp4Bw86dEnFNgMZSdOrWD14aB6z3ZTvOrNLd/+QqPL
# 0eQmoLrHiOb7go4hN9FA3OvGs4EBFH5iy1kbNoBNLE33fS5nS3+gIvmp7lQor6e1
# 0ILEGScRZSrFdBFjdpOQbxMFDypD40i8I25+x4CnUwqw5i4T74+IpVS65czrkrbx
# FPT74zv2c8+MZZRkEEXrt8R2KQ==
